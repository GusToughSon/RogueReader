...
Func Settings()
    ...
    While True
        ...
        If $msg = $GUI_EVENT_CLOSE Then
            MsgBox(0, "Event", "Window is closing.")
            ExitLoop
        ElseIf $msg = $GUI_EVENT_MINIMIZE Then
            GUICtrlSetData($labelStatus, "Window Status: Minimized")
            MsgBox(0, "Event", "Window has been minimized.")
        ElseIf $msg = $GUI_EVENT_MAXIMIZE Then
            GUICtrlSetData($labelStatus, "Window Status: Maximized")
            MsgBox(0, "Event", "Window has been maximized.")
        EndIf
    WEnd
